...
//    [str substringWithRange:NSMakeRange(0, 10)];
    ...
    NSDictionary *attributes = @{NSParagraphStyleAttributeName:paragraphStyle,NSKernAttributeName:@2};
    ...
    textview = [[UITextView alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(labe.frame), 200, 100)];
...
//        NSMutableParagraphStyle *paragraphStylefortext = [[NSMutableParagraphStyle alloc]init];
//    paragraphStylefortext.baseWritingDirection = NSWritingDirectionRightToLeft;
//    NSDictionary *attributesfortext = @{NSParagraphStyleAttributeName:paragraphStylefortext};
//    textview.attributedText =  [[NSAttributedString alloc]initWithString:textView.text attributes:attributesfortext];
